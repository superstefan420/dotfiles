...
static const char *fonts[]          = { "Hack Nerd Font FC Ligatured:size=14" };
static const char dmenufont[]       = "Hack Nerd Font FC Ligatured:size=14";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, "#252526" },
	[SchemeSel]  = { col_gray4, col_cyan,  "#545454"  },
